    ...
    <>
      ...
      <section className="py-16 sm:py-20 bg-[#F6F4EF]">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-[#1A1614]/70">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/shows"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#13264D] text-white rounded-lg font-semibold hover:bg-[#0D1B38] transition-colors"
            >
              Browse Shows
            </a>
            <a
              href="/plan-your-trip"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 border-2 border-[#1A1614] text-[#1A1614] rounded-lg font-semibold hover:bg-[#1A1614] hover:text-white transition-all"
            >
              Plan Your Trip
            </a>
          </div>
