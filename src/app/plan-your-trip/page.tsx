...
export default function PlanYourTripPage() {
  ...
  return (
    <>
            ...
            {seasonalTips.map((season) => (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold text-[#13264D]">
                    {season.season}
                  </h3>
                </div>
                <ul className="space-y-2">
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#13264D] font-heading mb-8 text-center">
            Branson Travel Tips
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl bg-[#faf8f5] border border-gray-100">
              <h3 className="font-bold text-[#13264D] mb-3">Getting There</h3>
            ...
            <div className="p-6 rounded-xl bg-[#faf8f5] border border-gray-100">
              <h3 className="font-bold text-[#13264D] mb-3">Getting Around</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="p-6 rounded-xl bg-[#faf8f5] border border-gray-100">
              <h3 className="font-bold text-[#13264D] mb-3">Where to Stay</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="p-6 rounded-xl bg-[#faf8f5] border border-gray-100">
              <h3 className="font-bold text-[#13264D] mb-3">Booking Tips</h3>
              <p className="text-sm text-gray-600">
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-br from-[#E8C65A] to-[#C04E0C]">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/shows"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#13264D] text-white rounded-xl font-semibold text-lg hover:bg-[#0D1B38] transition-colors"
            >
              Browse All Shows
            </Link>
            <Link
              href="/shows/deals"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-[#13264D] rounded-xl font-semibold text-lg hover:bg-gray-100 transition-colors"
            >
              View Deals
            </Link>
          </div>
